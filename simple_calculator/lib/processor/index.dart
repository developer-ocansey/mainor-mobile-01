import 'dart:async';
import 'package:simplecalculator/components/calculator_keys.dart';
import 'package:simplecalculator/models/history_model.dart';
import 'package:simplecalculator/processor/controller.dart';
import 'package:simplecalculator/processor/symbol.dart';
...
abstract class Processor {
  ...
  static void refresh() => _do(_output);

  static void _do(String data) => _controller.add(_output);
  ...
  static void _calculate() {
    ...
    HistoryService().add(history.toMap());
    refresh();
  }
